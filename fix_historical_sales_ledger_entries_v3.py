...
# -*- coding: utf-8 -*-
"""
歷史 SalesRecord 的 LedgerEntry 修正腳本（版本3）
...
try:
    ...
    with app.app_context():
        # 現在導入模型類
        from app import SalesRecord, LedgerEntry, FIFOSalesAllocation, CashAccount, FIFOInventory
...
if __name__ == "__main__":
    print("歷史 SalesRecord LedgerEntry 修正腳本 v3")
